...
number of brackets that can be reversed in order to make the
...
we would be left with the first opening bracket and hence
will not be able to make the expression balanced and the output
will be -1.
